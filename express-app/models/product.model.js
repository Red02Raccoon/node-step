...
var productSchema = mongoose.Schema(
  ...
  {
    //   collection: "products_1" кастомное имя коллекции
  }
);
...
module.exports = mongoose.model("Product", productSchema); // имя коллекции в БД будет "products"
